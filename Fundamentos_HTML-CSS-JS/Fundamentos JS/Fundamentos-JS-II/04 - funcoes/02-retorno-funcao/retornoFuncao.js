...
const resultado = calcularMedia(5, 5)
...
console.log(' A área de um retangulo é: ' + areaRetangular(3, 5))
...
console.log(' A área de um quadrado é: ' + areaQuadrada(8))
...
function olaMundo() {
  let texto = "..."
  return texto // a função acaba aqui no return
  texto = "Olá, mundo!" // isso aqui nao executa
  console.log(texto) // isso aqui nao executa
}
