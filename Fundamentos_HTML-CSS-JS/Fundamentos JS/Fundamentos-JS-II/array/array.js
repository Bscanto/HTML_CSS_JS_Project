...
console.log(' Adiciona um elemento ao final do array: ')
let tamanho = arr.push("Boromir");
console.log(arr); // ["Frodo", "Sam", "Merry", "Pippin", "Gandalf", "Aragorn", "Legolas", "Gimli", "Boromir"]
console.log(tamanho);

// unshift: Adiciona um elemento no início do array
console.log(' Adiciona um elemento no início do array: ')
...
console.log(' Remove o último elemento do array e retorna ele: ')
...
console.log(' Remove elemento no começo do array: ')
...
console.log(' Verifica se um certo elemento está presente no array: ');
const inclui = arr.includes("Gandalf");
console.log(inclui);

// indexOf: Encontra o índice que possui o elemento indicado, ou -1 caso ele não exista no array
console.log(' Encontra o índice que possui o elemento indicado, ou -1 caso ele não exista no array: ')
const indice = arr.indexOf("Gandalf");
console.log(indice);

//CORTAR E CONCATENAR
// slice: Copia uma parte do array e devolve a parte copiada sem alterar o array original
console.log(' Copia uma parte do array e devolve a parte copiada sem alterar o array original: ')
